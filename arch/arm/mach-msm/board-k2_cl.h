...
#define MSM_NC_GPIO_11				GPIO(11)
#define MSM_VP_I2C_SDA				GPIO(12)
#define MSM_VP_I2C_SCL				GPIO(13)
...
#define MSM_MB_ID1						GPIO(47)
#define MSM_MB_ID0						GPIO(48)
#define MSM_V_WL_IO_1V8_EN		GPIO(49)
#define MSM_RAW_INTR1					GPIO(50)
#define MSM_RAW_RSTN					GPIO(51)
#define MSM_V_BOOST_5V_EN			GPIO(52)
...
#define MSM_ANT_SW_SEL4				GPIO(112)
...
#define MSM_PARKING_BC1				GPIO(129)
...
extern struct msm_camera_board_info k2_cl_camera_board_info;
extern struct platform_device k2_cl_msm_rawchip_device;

int __init k2_cl_gpiomux_init(void);
int __init k2_cl_init_keypad(void);
void k2_init_panel(void);
